        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8 text-text-secondary leading-relaxed">
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">1. Datenschutz auf einen Blick</h3>
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-text-primary">Allgemeine Hinweise</h4>
                  <p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">2. Datenerfassung auf dieser Website</h3>
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-text-primary">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
                  <p>
                    Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten 
                    können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle" in dieser Datenschutzerklärung entnehmen.
                  </p>
                  
                  <h4 className="text-lg font-semibold text-text-primary">Wie erfassen wir Ihre Daten?</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Wofür nutzen wir Ihre Daten?</h4>
                  <p>
                    Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. 
                    Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
                  </p>
                  
                  <h4 className="text-lg font-semibold text-text-primary">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
                  <p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">3. Hosting</h3>
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-text-primary">Externes Hosting</h4>
                  <p>
                    Diese Website wird bei einem externen Dienstleister gehostet (Hoster). Die personenbezogenen Daten, 
                    die auf dieser Website erfasst werden, werden auf den Servern des Hosters / der Hoster gespeichert. 
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">4. Allgemeine Hinweise und Pflichtinformationen</h3>
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-text-primary">Datenschutz</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Hinweis zur verantwortlichen Stelle</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Speicherdauer</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h4>
                  <p>
                    ...
                    EINE VERARBEITUNG BERUHT, ENTNEHMEN SIE DIESER DATENSCHUTZERKLÄRUNG. WENN SIE WIDERSPRUCH EINLEGEN, 
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Recht auf Datenübertragbarkeit</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Auskunft, Löschung und Berichtigung</h4>
                  <p>
                  ...
                  <h4 className="text-lg font-semibold text-text-primary">Recht auf Einschränkung der Verarbeitung</h4>
                  <p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">5. Datenerfassung auf dieser Website</h3>
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-text-primary">Kontaktformular</h4>
                  <p>
                  ...
                  <p>
                    ...
                    oder auf Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) sofern diese abgefragt wurde; die Einwilligung 
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">6. Plugins und Tools</h3>
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-text-primary">Google Fonts (lokales Hosting)</h4>
                  <p>
                    Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Google Fonts, 
                    die von Google bereitgestellt werden. Die Google Fonts sind lokal installiert. Eine Verbindung 
                    zu Servern von Google findet dabei nicht statt.
                  </p>
                  <p>
                    Weitere Informationen zu Google Fonts finden Sie unter 
                    <a href="https://developers.google.com/fonts/faq" className="text-primary-blue hover:underline ml-1">
                      https://developers.google.com/fonts/faq
                    </a> und in der Datenschutzerklärung von Google: 
                    <a href="https://policies.google.com/privacy?hl=de" className="text-primary-blue hover:underline ml-1">
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">7. Änderungen und Aktualisierungen der Datenschutzerklärung</h3>
                <p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-text-primary mb-4">8. Kontakt</h3>
                <p>
